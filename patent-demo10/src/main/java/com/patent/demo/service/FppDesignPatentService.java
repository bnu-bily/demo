 ...
 * @since 2018-07-22
 */
public interface FppDesignPatentService extends IService<FppDesignPatent> {
...
//    void register(String patentId, String patentName, String inventor, String userId, String userName );
    ...
    List<FppDesignPatent> selectPatentByUser(String param);

    void register(String applicationNumber,
